...
public class FrontController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// /cars/:id, /users/:id. I want to call CarDAOImpl.get(id) for one and userDAOImpl.get(id) for the other. This is "branching"
		switch (parts[2]) {
			case "car":
				//I could call a CarService here and pas request and response to deal with them there
