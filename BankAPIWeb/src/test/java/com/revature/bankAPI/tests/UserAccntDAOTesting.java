...
public class UserAccntDAOTesting {
	...
	//Typically the User and account tables and dropped and recreated before each test.
	@Test
	...
	public void testAccount1() {
		...
		changeEmpAccnt.setUser(employee);
		...
		changeEmpAccnt2.setUser(employee);
	...
	public void testAccount2() {
		...
		changeGenAccnt.setUser(general);
		...
		changeGenAccnt2.setUser(general);
